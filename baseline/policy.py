...
- Selects one of the candidate planets
"""
class PlanetPolicy(nn.Module):
    ...
    def forward(
        ...
        # Separate encoders for self, global, and candidate features
        ...
        # The feature embeddings are concatenated to produce a score for each candidate
